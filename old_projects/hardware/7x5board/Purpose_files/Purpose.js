...
{return false;}
function onPageLoad()
{loadMozillaCSS('Purpose_files/PurposeMoz.css')
adjustLineHeightIfTooBig('id1');adjustFontSizeIfTooBig('id1');adjustLineHeightIfTooBig('id2');adjustFontSizeIfTooBig('id2');fixAllIEPNGs('Media/transparent.gif');IMpreload('Purpose_files','shapeimage_4','0');IMpreload('Purpose_files','shapeimage_4','1');fixupAllIEPNGBGs();applyEffects()}
